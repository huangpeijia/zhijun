		...
		<div class="div_main">
			...
			<div>
				...
				<div class="div_content pro cf">
					<div class="div_pro1 div_title_opacity">
						<img src="${APP_PATH }/js/front/img/images/cpt1.png"/>
						<div class="pro_span">
							<div class="">
								<span>Federal Signal 的PAGA 是一款全新的数字广播告警系统，采用D类功放，效率达到84%以上，发热量小，可维护性高。</span>
							</div>
						</div>
						<div class="pro_span_title">PAGA广播告警系统</div>
					</div>
					<div class="">
						<div class="div_pro2 div_title_opacity">
							<img src="${APP_PATH }/js/front/img/images/cpt2.png"/>
							<div class="pro_span">
								<div class="">
									<span>Federal Signal 的PAGA 是一款全新的数字广播告警系统，采用D类功放，效率达到84%以上，发热量小，可维护性高。</span>
								</div>
						...
						<div class="div_pro3 div_title_opacity">
							<img src="${APP_PATH }/js/front/img/images/cpt3.png"/>
							<div class="pro_span">
								<div class="">
									<span>Federal Signal 的PAGA 是一款全新的数字广播告警系统，采用D类功放，效率达到84%以上，发热量小，可维护性高。</span>
					...
					<div class="">
						<div class="div_pro4 div_title_opacity">
							<img src="${APP_PATH }/js/front/img/images/cpt4.png"/>
							<div class="pro_span">
								<div class="">
									<span>Federal Signal 的PAGA 是一款全新的数字广播告警系统，采用D类功放，效率达到84%以上，发热量小，可维护性高。</span>
								</div>
			...
			<div>
				...
				<div class="div_content cf">
					<div class="float_l">
						<ul class="ul_news cf">
							<li><a href="#"><span>改革改革改革改革改革改革改革改革改革改革...</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革改革改革改...</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革改革改革改革改革改革</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革改革改革改革改</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革改革改革改革改</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革改革改革</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革改革改革改革改</span><span>2018-08-06</span></a></li>
							<li><a href="#"><span>改革改革改革改革改革</span><span>2018-08-06</span></a></li>
						</ul>
						<a href="#" class="news_more float_r ">更多>></a>
					</div>
					<video id="media" class="div_video float_r" poster="" controls>
						<source src="${APP_PATH }/js/front/video/zjsd.mp4" type="video/mp4">
					</video>
				</div>
			</div>
			<!--层4-->
			<div class="">
				...
				<div class="div_content cf">
					<ul class="ul_case">
						<a href="#" class="">
							<li class="">
								<img src="${APP_PATH }/js/front/img/images/cgal1.png" class=""/>
								<div class="div_case float_r">
									<div class="case_title cf"><span>广东天然气管网项目视频会议系统</span><span class="">2018-08-06</span></div>
									<div class="case_content">dasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf adf asdf
										asasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf adf asdf asasdfasdasdfdasdf asdf
										asdf asdf asdf asdf asdf adf asdf asasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf
										adf asdf asdf asdf asdf asdf asdfa sdf  as asdf asdf asdf asdf adsf asdf asdf as
										asdf asdf asdf asdf asdf asdf asdf asd fasdf sa,sdf ,asdf as,df asdf as.a sfasd f,a
									</div>
								</div>
							</li>
						</a>
						<a href="#" class="">
							<li class="">
								<img src="${APP_PATH }/js/front/img/images/cgal2.png" class=""/>
								<div class="div_case float_r">
									<div class="case_title cf"><span>广东天然气管网项目视频会议系统</span><span class="">2018-08-06</span></div>
									<div class="case_content">dasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf adf asdf
										asasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf adf asdf asasdfasdasdfdasdf asdf
						...
						<a href="#" class="">
							<li class="">
								<img src="${APP_PATH }/js/front/img/images/cgal3.png" class=""/>
								<div class="div_case float_r">
									<div class="case_title cf"><span>广东天然气管网项目视频会议系统</span><span class="">2018-08-06</span></div>
									<div class="case_content">dasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf adf asdf
										asasdfasdasdfdasdf asdf asdf asdf asdf asdf asdf adf asdf asasdfasdasdfdasdf asdf
...
<div class="div_footer">
	...
	<div class="center_footer cf">
		...
		<div class="footer_center float_r">
			<ul>
				<li>地址：深圳市南山区海王大厦A座7F</li>
				<li>电话：（86-755）26416922</li>
				<li>传真：（08-755）26415322</li>
				<li>Email：sales@zhijunshidai.com</li>
			</ul>
		</div>
	</div>
	<!--下 版权信息-->
	<div class="bottom_footer">
		<p class="">智钧时代科技有限公司&nbsp;&copy;版权所有 粤ICP备12345678号 -1 2018 -2020 zhijun.com all Right Reserved.</p>
	</div>
</div>
