...
public class NewsDao {
	...
	public int addNews(News news) {
		String sql = "insert into news(news_title, news_constant, news_type, news_time) value(?,?,?,?)";
	...
	public List<News> query(int news_id) {
		String sql = "select news_id, news_title, news_constant, news_type,news_time from news where news_id="+news_id+"";
		List<News> list = jdbcTemplate.query(sql, new NewsMapper());
		return list;
	}
	/**
	...
	public int update(News news) {
		String sql = "update news set news_title=?,news_constant=?,news_type=?,news_time=? where news_id=?";
